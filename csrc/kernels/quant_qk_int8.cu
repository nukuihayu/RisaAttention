...
//   No __syncthreads; all reductions are warp-local.
//
...
using risa::quant_int8_rcp;
using risa::store4_i8;
using risa::warp_reduce_fmax;
...
// ---------------------------------------------------------------------------
// Fused Q+K kernel: fallback for non-standard tile configurations.
