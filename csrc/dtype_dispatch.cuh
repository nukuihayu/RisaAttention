...
#define DISPATCH_INPUT_DTYPE(dtype_code, type_name, ...)                       \
    [&] {                                                                       \
        switch (dtype_code) {                                                   \
            case risa::DTYPE_CODE_FLOAT32: {                                    \
                using type_name = float;                                        \
                return __VA_ARGS__();                                           \
            }                                                                   \
            case risa::DTYPE_CODE_FLOAT16: {                                    \
                using type_name = half;                                         \
                return __VA_ARGS__();                                           \
            }                                                                   \
            case risa::DTYPE_CODE_BFLOAT16: {                                   \
...
#define DISPATCH_FP8_OUTPUT_DTYPE(dtype_code, type_name, ...)                  \
    [&] {                                                                       \
        switch (dtype_code) {                                                   \
            case risa::DTYPE_CODE_FLOAT8_E4M3FN: {                              \
                using type_name = __nv_fp8_e4m3;                                \
                return __VA_ARGS__();                                           \
            }                                                                   \
            case risa::DTYPE_CODE_FLOAT8_E5M2: {                                \
